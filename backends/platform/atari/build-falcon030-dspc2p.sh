...
#
# The Falcon030 game build of build-falcon030.sh with the game screen's
...
# scumm-7-8 adds The Dig (engines/scumm/metaengine.cpp).
#
# The DSP kernel's image, dsp-c2p-image.h, comes from
# devtools/atari-falcon030/tools/ssi-dma-c2p/build.sh.

mkdir -p build-falcon030-dspc2p
cd build-falcon030-dspc2p
...
../configure \
	...
	--disable-all-engines \
	--enable-engine=scumm,scumm-7-8,sci,sky,cruise \
	--disable-translation \
	--disable-cloud \
	--disable-tts \
